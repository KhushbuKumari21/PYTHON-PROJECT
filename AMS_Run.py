...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Label(ec, text='PLEASE ENTER YOUR SUBJECT NAME!!!', fg='pink',
              bg='white', font=('times', 20, ' BOLD ')).pack()
        Button(ec, text='OK', command=ec_delete, fg="black", bg="lawn green", width=10, height=1, activebackground="lightpink",
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            MFW.configure(background='navyblue')
            ...
            def err_screen1():
                ...
                Label(errsc2, text='PLEASE  ENTER STUDENT  AND  ENOROLLMENT!!!', fg='black', bg='white',
            ...
            ENR = tk.Label(MFW, text="Enter Enrollment", width=15, height=2, fg="black", bg="orange",
                           font=('times', 15))
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'khushbukumari':
            if password == 'khushbukumari123':
                win.destroy()
                import csv
                import tkinter
                root = tkinter.Tk()
    ...
    un = tk.Label(win, text="Enter USERNAME : ", width=16, height=2, fg="black", bg="green",
                  font=('times', 15, ' bold '))
    un.place(x=30, y=50)

    pw = tk.Label(win, text="ENTER PASSWORD : ", width=16, height=2, fg="black", bg="green",
                  font=('times', 15, ' bold '))
    pw.place(x=30, y=150)
...
lbl2 = tk.Label(window, text="Enter Name : ", width=20, fg="black",
                bg="orange", height=2, font=('times', 15, ' bold '))
...
AP = tk.Button(window, text="Check Present Students", command=admin_panel, fg="black",
               bg="SkyBlue1", width=19, height=1, activebackground="white", font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images", command=take_img, fg="black", bg="pink",
                    width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images", fg="black", command=trainimg, bg="pink",
                     width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance", fg="black", command=subjectchoose,
               bg="pink", width=20, height=3, activebackground="skyblue", font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill, fg="black",
                       bg="pink", width=20, height=3, activebackground="skyblue1", font=('times', 15, ' bold '))
